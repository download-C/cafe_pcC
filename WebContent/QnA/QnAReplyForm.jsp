...
<link href="./css/qnareplyform.css" rel="stylesheet" type="text/css">
...
<!-- 헤더들어가는 곳 -->
	...
	<hr>
		...
		내용 <textarea rows="4" cols="60 " name="qna_content"></textarea> <br>
		</div>
		<div>
