...
public class QnABoardDTO {
	...
	public String toString() {
		return "QnABoardDTO [qna_num=" + qna_num + ", qna_writer_type=" + qna_writer_type + ", mgr_num=" + mgr_num
				+ ", mem_num=" + mem_num + ", qna_password=" + qna_password + ", qna_subject=" + qna_subject
				+ ", qna_content=" + qna_content + ", qna_readcount=" + qna_readcount + ", qna_re_ref=" + qna_re_ref
				+ ", qna_re_lev=" + qna_re_lev + ", qna_re_seq=" + qna_re_seq + ", qna_date=" + qna_date + ", qna_ip="
				+ qna_ip + ", qna_file=" + qna_file + "]";
	}
